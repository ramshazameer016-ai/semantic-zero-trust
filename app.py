...
# ────────────────────────────────────────────────────────────────────────
# CELL 2: Data Loading (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
@st.cache_data
def load_data():
    print("\n" + "="*70)
...
# ────────────────────────────────────────────────────────────────────────
# CELL 3: Feature Engineering (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
@st.cache_data
def engineer_features(df_input):
    ...
    print(f"✅ Feature engineering complete. Total numeric features: {len(numeric_feature_cols)}")
    return df_out, numeric_feature_cols

# ────────────────────────────────────────────────────────────────────────
# CELL 4: Model Classes (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────
# CELL 5: Train Model (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
@st.cache_resource
...
# ────────────────────────────────────────────────────────────────────────
# EXECUTE - This will give you EXACTLY THE SAME RESULTS
# ────────────────────────────────────────────────────────────────────────
with st.spinner("Loading data and training model... (may take a few minutes)"):
    df = load_data()
    df, feature_cols = engineer_features(df)
    learner, X_test, y_test = train_model(df, feature_cols)

# ────────────────────────────────────────────────────────────────────────
# CELL 6: Model Performance (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
...
# Display metrics (same values as original)
...
# ────────────────────────────────────────────────────────────────────────
# CELL 7: Test Set Predictions (EXACT SAME DATA AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
...
# Display first 10 rows (EXACT SAME as original notebook)
st.write("**First 10 Predictions:**")
st.dataframe(full_test_results.head(10))

st.write("**Prediction Distribution:**")
pred_counts = full_test_results['Predicted_Class'].value_counts().rename({0: 'Normal', 1: 'Threat'})
st.dataframe(pred_counts.to_frame())

# New data sample (EXACT SAME as original)
...
# ────────────────────────────────────────────────────────────────────────
# CELL 8: SHAP Feature Importance (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
...
try:
    with st.spinner("Computing SHAP values..."):
        ...
        # Top 5 features (EXACT SAME as original)
...
# ────────────────────────────────────────────────────────────────────────
# CELL 9: Model Comparison (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
...
# ────────────────────────────────────────────────────────────────────────
# CELL 10: Semantic Enricher (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
...
st.success(f"✅ Knowledge Graph populated with {len(kg)} triples")

# ────────────────────────────────────────────────────────────────────────
# CELL 11: Policy Mapping (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
risk_policy_map = {
...
# ────────────────────────────────────────────────────────────────────────
# CELL 12: Policy Enforcement Simulation (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
...
st.write(f"**Target User:** {test_user}")
st.write(f"**Detected Risk Factors:** {detected_for_test}")
st.write(f"**Enforcement Actions:** {enforcement_actions}")

st.markdown("---")

# ────────────────────────────────────────────────────────────────────────
# CELL 13: Zero Trust Simulation (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
st.subheader("🚀 Zero Trust Policy Enforcement Simulation")
...
# Action distribution (EXACT SAME as original)
...
# ────────────────────────────────────────────────────────────────────────
# CELL 14: Comparative Analysis (EXACT SAME AS ORIGINAL)
# ────────────────────────────────────────────────────────────────────────
